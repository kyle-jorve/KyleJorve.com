...
function animateContent(o,t,f,a,n,d){function e(){var o=$(window).outerWidth(),t=$(window).scrollTop()+$(window).outerHeight();if(("top"==u?s.offset().top+d:s.offset().top+s.outerHeight()+d)<=t&&a<o)for(i=0;i<l.length;i++){var n=l[i],e=i*f+f;!function(o){setTimeout(function(){$(o).addClass("animate")},e)}(n)}else o<=a&&l.removeClass("animatedEl")}var r=$(o),s="top"==n?r.find(t).first():r.find(t).last(),l=r.find(t),u="top"==n?"top":"bottom";$(window).on("resize",e),$(document).ready(function(){e(),$(window).on("scroll",e)})}
var bodyScrollLim=100;function bodyScroll(e){e<=$(window).scrollTop()?$("body").addClass("scrolled"):$("body").removeClass("scrolled")}function detectTouchDevice(){return"ontouchstart"in document.documentElement}function detectMobile(){return void 0!==window.orientation||-1!==navigator.userAgent.indexOf("IEMobile")}$(document).ready(function(){detectTouchDevice()&&$("body").addClass("touchDevice"),detectMobile()&&$("body").addClass("mobile"),$(".button, button, a").on("tap",function(){var e=$(this);setTimeout(function(){e.removeClass("hover")},300)}),$(window).scroll(function(){bodyScroll(bodyScrollLim)})}),$(window).on("load",function(){bodyScroll(bodyScrollLim),$("body").removeClass("preload")}),window.addEventListener("load",function(){document.querySelector("#loadScreen").classList.remove("active")}),function(){function e(){t=o.header.offsetHeight,n=600<window.innerWidth?32:16,o.buffers.forEach(function(e){var o=e.classList.contains(i);e.style.paddingTop=(o?t+n:t)+"px"})}var o,t,n,r="headerBuffer",i="headerBuffer--extra";window.addEventListener("DOMContentLoaded",function(){o={buffers:Array.prototype.slice.call(document.querySelectorAll("."+r)),header:document.querySelector("header")}}),window.addEventListener("load",e),window.addEventListener("resize",e)}(),function(){function e(){t.lb.classList.remove(i),setTimeout(function(){t.lbWrp.classList.remove(i)},n)}var o,t,n,r,i="active",d=-1<(o=window.navigator.userAgent.toLowerCase()).indexOf("msie")||-1<o.indexOf("trident");window.addEventListener("DOMContentLoaded",function(){t={lbWrp:document.querySelector("#ieLbWrp"),lb:document.querySelector("#ieLb"),close:document.querySelector("#closeIELb"),overlay:document.querySelector("#ieLbOverlay")},r=1e3*parseFloat(window.getComputedStyle(t.lbWrp).getPropertyValue("transition-duration")),n=1e3*parseFloat(window.getComputedStyle(t.lb).getPropertyValue("transition-duration")),t.close.addEventListener("click",e),t.overlay.addEventListener("click",e)}),window.addEventListener("load",function(){d&&(t.lbWrp.classList.add(i),setTimeout(function(){t.lb.classList.add(i)},r))})}(),function(){var r,i=window.location.href.replace(window.location.hash,""),d="/"===i.charAt(i.length-1)?i.substring(0,i.length-1):i,a=window.location.host,l=window.location.origin;window.addEventListener("DOMContentLoaded",function(){(r={header:document.querySelector("header"),links:Array.prototype.slice.call(document.querySelectorAll("a")),loader:document.querySelector("#loadScreen"),samePageHashes:[],scrollAnchors:$("html, body")}).links=r.links.filter(function(e){var o=e.href,t=-1<o.indexOf("#"),n=function(e,o){var t=e.hash,n=i+t===o,r=d===l?"#"===o.replace(i,"").charAt(0):"#"===o.replace(d,"").charAt(0);return n||r}(e,o);if(function(e){return-1<e.indexOf(a)}(o)){if(!t)return e;if(!n)return e;r.samePageHashes.push(e)}})}),window.addEventListener("load",function(){1e3*parseFloat(window.getComputedStyle(r.loader).getPropertyValue("transition-duration"))})}();
var bodyScrollLim=100;function bodyScroll(e){e<=$(window).scrollTop()?$("body").addClass("scrolled"):$("body").removeClass("scrolled")}function detectTouchDevice(){return"ontouchstart"in document.documentElement}function detectMobile(){return void 0!==window.orientation||-1!==navigator.userAgent.indexOf("IEMobile")}$(document).ready(function(){detectTouchDevice()&&$("body").addClass("touchDevice"),detectMobile()&&$("body").addClass("mobile"),$(".button, button, a").on("tap",function(){var e=$(this);setTimeout(function(){e.removeClass("hover")},300)}),$(window).scroll(function(){bodyScroll(bodyScrollLim)})}),$(window).on("load",function(){bodyScroll(bodyScrollLim),$("body").removeClass("preload")}),window.addEventListener("load",function(){document.querySelector("#loadScreen").classList.remove("active")}),function(){function e(){o=t.header.offsetHeight,n=600<window.innerWidth?32:16,t.buffers.forEach(function(e){var t=e.classList.contains(i);e.style.paddingTop=(t?o+n:o)+"px"})}var t,o,n,r="headerBuffer",i="headerBuffer--extra";window.addEventListener("DOMContentLoaded",function(){t={buffers:Array.prototype.slice.call(document.querySelectorAll("."+r)),header:document.querySelector("header")}}),window.addEventListener("load",e),window.addEventListener("resize",e)}(),function(){function e(){o.lb.classList.remove(i),setTimeout(function(){o.lbWrp.classList.remove(i)},n)}var t,o,n,r,i="active",d=-1<(t=window.navigator.userAgent.toLowerCase()).indexOf("msie")||-1<t.indexOf("trident");window.addEventListener("DOMContentLoaded",function(){o={lbWrp:document.querySelector("#ieLbWrp"),lb:document.querySelector("#ieLb"),close:document.querySelector("#closeIELb"),overlay:document.querySelector("#ieLbOverlay")},r=1e3*parseFloat(window.getComputedStyle(o.lbWrp).getPropertyValue("transition-duration")),n=1e3*parseFloat(window.getComputedStyle(o.lb).getPropertyValue("transition-duration")),o.close.addEventListener("click",e),o.overlay.addEventListener("click",e)}),window.addEventListener("load",function(){d&&(o.lbWrp.classList.add(i),setTimeout(function(){o.lb.classList.add(i)},r))})}(),function(){var e,d,n,r,t,o,c=window.location.href.replace(window.location.hash,""),a="/"===c.charAt(c.length-1)?c.substring(0,c.length-1):c,l=window.location.host,u=window.location.origin;window.location.pathname;window.addEventListener("load",function(){e=Array.prototype.slice.call(document.querySelectorAll("a")),d=[],e=e.filter(function(e){var t=e.href,o=-1<t.indexOf("#"),n=function(e,t){var o=e.hash,n=c+o===t,r=a===u?"#"===t.replace(c,"").charAt(0):"#"===t.replace(a,"").charAt(0);return n||r}(e,t),r=function(e){return-1<e.indexOf(l)}(t),i=e.hasAttribute("download")||e.classList.contains("download");if(r)if(o){if(!n)return e;d.push(e)}else if(!i)return e}),n=document.querySelector("header"),r=$("html, body"),t=document.querySelector("#loader"),o=1e3*parseFloat(window.getComputedStyle(t).getPropertyValue("transition-duration")),e.forEach(function(e){e.addEventListener("click",function(e){var t=e.currentTarget.href;e.preventDefault(),showLoader(),setTimeout(function(){window.location=t},o)})}),d.forEach(function(e){e.addEventListener("click",function(e){var t=n.offsetHeight+16,o=document.querySelector(e.currentTarget.hash).getBoundingClientRect().top+window.scrollY;e.preventDefault(),document.querySelector("body").classList.contains("showMobileNav")&&document.querySelector("#navBtn").click(),r.animate({scrollTop:o-t},1e3)})})})}();
$(document).ready(function(){var t,e,i,a,n,o,s,c,l="#topNav";0<$(l).length&&(t=$(l).find("nav li"),e=1e3*parseFloat(window.getComputedStyle(document.querySelector(l)).transitionDuration)/2,i=$(l).find(".recentWorkContainer"),a=$(l).find(".portfolioItem"),n=$(l).find(".iconContainer li"),o=t.length,s=n.length,c=100*o,$("#navBtn").on("click tap",function(){$("html").hasClass("showMobileNav")?($(this).removeClass("active"),t.each(function(t){var e=100*(o-t-1),i=$(this);setTimeout(function(){i.removeClass("active")},e)}),i.removeClass("active"),a.each(function(t){var e=100*(s-t-1),i=$(this);setTimeout(function(){i.removeClass("active")},e)}),n.each(function(t){var e=100*(s-t-1),i=$(this);setTimeout(function(){i.removeClass("active")},e)}),setTimeout(function(){$("html").removeClass("showMobileNav")},c)):($("html").addClass("showMobileNav"),$(this).addClass("active"),setTimeout(function(){t.each(function(t){var e=100*t,i=$(this);setTimeout(function(){i.addClass("active")},e)}),i.addClass("active"),a.each(function(t){var e=100*t,i=$(this);setTimeout(function(){i.addClass("active")},e)}),n.each(function(t){var e=100*t,i=$(this);setTimeout(function(){i.addClass("active")},e)})},e))}))});
function parallaxBg(o,t,s,a,d){$(o).each(function(){function o(){var o=$("body").scrollTop()>$("html").scrollTop()?$("body").scrollTop():$("html").scrollTop(),t=i.outerHeight(),r=(i.outerWidth(),i.offset().top),n=$(window).outerWidth(),l=$(window).outerHeight(),c=(o-r)/t*s*t;o<=t+r&&r<o+l&&a<n?e.css({"background-attachment":"fixed","background-position":d+" "+c+"px"}):n<=a&&e.css({"background-attachment":"scroll","background-position":"center center"})}var i=$(this),e=i.find(t);$(document).ready(o),$(window).on("scroll resize",o)})}function parallaxBgAlt(o,t,s,a,d){$(o).each(function(){function o(){var o=$("body").scrollTop()>$("html").scrollTop()?$("body").scrollTop():$("html").scrollTop(),t=i.height(),r=i.offset().top,n=$(window).outerWidth(),l=$(window).outerHeight(),c=((o-r)/t+.5)*s*t;o<=t+r&&r<o+l&&a<n&&e.css("background-position",d+" "+c+"px")}var i=$(this),e=i.find(t);$(document).ready(o),$(window).on("scroll resize",o)})}function parallax(o,r,e,s){$(o).each(function(){function o(){var o=$("body").scrollTop()>$("html").scrollTop()?$("body").scrollTop():$("html").scrollTop(),t=$(window).outerHeight(),r=$(window).outerWidth(),n=(o-i)/c*e*c;o<=i+c&&i<o+t&&s<r?l.css("transform","translateY("+n+"px)"):r<=s&&l.removeAttr("style")}var t=$(this),l=t.find(r),c=t.outerHeight(),i=t.offset().top;$(document).ready(function(){l.addClass("parallaxEl")}),$(window).on("scroll resize",o)})}