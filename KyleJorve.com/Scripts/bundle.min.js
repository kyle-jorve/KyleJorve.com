...
var bodyScrollLim=100;function bodyScroll(e){e<=$(window).scrollTop()?$("body").addClass("scrolled"):$("body").removeClass("scrolled")}function detectTouchDevice(){return"ontouchstart"in document.documentElement}function detectMobile(){return void 0!==window.orientation||-1!==navigator.userAgent.indexOf("IEMobile")}$(document).ready(function(){detectTouchDevice()&&$("body").addClass("touchDevice"),detectMobile()&&$("body").addClass("mobile"),$(".button, button, a").on("tap",function(){var e=$(this);setTimeout(function(){e.removeClass("hover")},300)}),$(window).scroll(function(){bodyScroll(bodyScrollLim)})}),window.addEventListener("pageshow",function(e){e.persisted&&window.location.reload()}),$(window).on("load",function(){bodyScroll(bodyScrollLim),$("body").removeClass("preload")}),window.addEventListener("load",function(){document.querySelector("#overlay").classList.add("overlay--loaded")}),function(){function e(){t=o.header.offsetHeight,n=600<window.innerWidth?32:16,o.buffers.forEach(function(e){var o=e.classList.contains(r);e.style.paddingTop=(o?t+n:t)+"px"})}var o,t,n,i="headerBuffer",r="headerBuffer--extra";window.addEventListener("DOMContentLoaded",function(){o={buffers:Array.prototype.slice.call(document.querySelectorAll("."+i)),header:document.querySelector("header")}}),window.addEventListener("load",e),window.addEventListener("resize",e)}(),function(){function e(){t.lb.classList.remove(r),setTimeout(function(){t.lbWrp.classList.remove(r)},n)}var o,t,n,i,r="active",a=-1<(o=window.navigator.userAgent.toLowerCase()).indexOf("msie")||-1<o.indexOf("trident");window.addEventListener("DOMContentLoaded",function(){t={lbWrp:document.querySelector("#ieLbWrp"),lb:document.querySelector("#ieLb"),close:document.querySelector("#closeIELb"),overlay:document.querySelector("#ieLbOverlay")},i=1e3*parseFloat(window.getComputedStyle(t.lbWrp).getPropertyValue("transition-duration")),n=1e3*parseFloat(window.getComputedStyle(t.lb).getPropertyValue("transition-duration")),t.close.addEventListener("click",e),t.overlay.addEventListener("click",e)}),window.addEventListener("load",function(){a&&(t.lbWrp.classList.add(r),setTimeout(function(){t.lb.classList.add(r)},i))})}();var localLinks=function(){function e(e){var i={samePage:[],hashes:[]};return e.forEach(function(e){var o=e.href,t=-1<o.indexOf("#"),n=function(e,o){var t=e.hash,n=a+t===o,i=l===c?"#"===o.replace(a,"").charAt(0):"#"===o.replace(l,"").charAt(0);return n||i}(e,o);!function(e){return-1<e.indexOf(d)}(o)||null!==e.getAttribute("download")||(t&&n?i.hashes.push(e):i.samePage.push(e))}),i}var t,n,i,r="active",a=window.location.href.replace(window.location.hash,""),l="/"===a.charAt(a.length-1)?a.substring(0,a.length-1):a,d=window.location.host,c=window.location.origin;return{init:function(){window.addEventListener("DOMContentLoaded",function(){(n={header:document.querySelector("header"),links:Array.prototype.slice.call(document.querySelectorAll("a")),portfolioLinks:[],overlayClick:document.querySelector("#overlayClick"),samePageHashes:[],scrollAnchors:$("html, body")}).links.forEach(function(e){e.href.substring(0,e.href.lastIndexOf("/")).includes("/portfolio/")&&n.portfolioLinks.push(e)}),n.portfolioLinks.forEach(function(e){e.href+="?from="+window.curPgID}),n.links=e(n.links)}),window.addEventListener("load",function(){i=1e3*parseFloat(window.getComputedStyle(n.overlayClick).getPropertyValue("transition-duration")),t=n.header.offsetHeight+16,n.links.samePage.forEach(function(o){o.addEventListener("click",function(){var e=o.href;event.preventDefault(),n.overlayClick.classList.add(r),setTimeout(function(){window.location=e},i)})}),n.links.hashes.forEach(function(o){o.addEventListener("click",function(){var e=document.querySelector(o.hash).getBoundingClientRect().top+window.pageYOffset;event.preventDefault(),n.scrollAnchors.animate({scrollTop:e-t},1e3)})})})},returnLocalLinks:e}}();localLinks.init();
