...
function animateContent(o,t,n,e,f,a){var d=$(o),r="top"==f?d.find(t).first():d.find(t).last(),s=d.find(t),l="top"==f?"top":"bottom",u=function(){var o=$(window).outerWidth(),t=$(window).scrollTop()+$(window).outerHeight();if(("top"===l?r.offset().top+a:r.offset().top+r.outerHeight()+a)<=t&&o>e)for(i=0;i<s.length;i++){var f=s[i],d=i*n+n;!function(o){setTimeout(function(){$(o).addClass("animate")},d)}(f)}else o<=e&&s.removeClass("animatedEl")};$(window).on("resize",u),$(document).ready(function(){u(),$(window).on("scroll",u)})}
var bodyScrollLim=100;$(document).ready(function(){detectTouchDevice()&&$("body").addClass("touchDevice"),detectMobile()&&$("body").addClass("mobile"),$(".button, button, a, .toTopBtn, li.hasSubnav").hover(function(){$("body").hasClass("touchDevice")&&$(this).addClass("hover")},function(){$("body").hasClass("touchDevice")&&$(this).removeClass("hover")}),$(".button, button, a, .toTopBtn").on("tap",function(){var o=$(this);setTimeout(function(){o.removeClass("hover")},300)}),$("img").each(function(){$(this).parent().is("p")&&$(this).unwrap()}),$("img").removeAttr("style"),$(window).scroll(function(){bodyScroll(bodyScrollLim)})}),$(window).on("load",function(){bodyScroll(bodyScrollLim),$("body").removeClass("preload")}),window.addEventListener("load",function(){document.querySelector("#loadScreen").classList.remove("active")});function bodyScroll(o){$(window).scrollTop()>=o?$("body").addClass("scrolled"):$("body").removeClass("scrolled")}function detectTouchDevice(){return"ontouchstart"in document.documentElement}function detectMobile(){return void 0!==window.orientation||-1!==navigator.userAgent.indexOf("IEMobile")}
$(document).ready(function(){$('a[href^="#"]').on("click",function(t){var e=$(this).attr("href"),a=$(e).offset().top-$("header").outerHeight();t.preventDefault(),$("html, body").animate({scrollTop:a},1e3,"swing")});var t,e,a,o,i,n,s,c;$("#topNav").length>0&&(t=$("#topNav").find("nav li"),e=1e3*parseFloat(window.getComputedStyle(document.querySelector("#topNav")).transitionDuration)/2,a=$("#topNav").find(".recentWorkContainer"),o=$("#topNav").find(".portfolioItem"),i=$("#topNav").find(".iconContainer li"),n=t.length,s=i.length,c=100*n,$("#navBtn").on("click tap",function(){$("body").hasClass("showMobileNav")?($(this).removeClass("active"),t.each(function(t){var e=100*(n-t-1),a=$(this);setTimeout(function(){a.removeClass("active")},e)}),a.removeClass("active"),o.each(function(t){var e=100*(s-t-1),a=$(this);setTimeout(function(){a.removeClass("active")},e)}),i.each(function(t){var e=100*(s-t-1),a=$(this);setTimeout(function(){a.removeClass("active")},e)}),setTimeout(function(){$("body").removeClass("showMobileNav")},c)):($("body").addClass("showMobileNav"),$(this).addClass("active"),setTimeout(function(){t.each(function(t){var e=100*t,a=$(this);setTimeout(function(){a.addClass("active")},e)}),a.addClass("active"),o.each(function(t){var e=100*t,a=$(this);setTimeout(function(){a.addClass("active")},e)}),i.each(function(t){var e=100*t,a=$(this);setTimeout(function(){a.addClass("active")},e)})},e))}))});
