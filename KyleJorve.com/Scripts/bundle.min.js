...
function animateContent(o,t,n,e,f,d){var a=$(o),s="top"==f?a.find(t).first():a.find(t).last(),r=a.find(t),u="top"==f?"top":"bottom",w=function(){var o=$(window).outerWidth(),t=$(window).scrollTop()+$(window).outerHeight();if(("top"===u?s.offset().top+d:s.offset().top+s.outerHeight()+d)<=t&&o>e)for(i=0;i<r.length;i++){var f=r[i],a=i*n+n;!function(o){setTimeout(function(){$(o).addClass("animate")},a)}(f)}else o<=e&&r.removeClass("animatedEl")};$(window).on("load",function(){setTimeout(function(){w()},300)}),$(window).on("resize",w),$(document).ready(function(){$(window).on("scroll",w)})}
...
$(document).ready(function(){$('a[href^="#"]').on("click",function(e){var t=$(this).attr("href"),i=$(t).offset().top-$("header").outerHeight();e.preventDefault(),$("html, body").animate({scrollTop:i},1e3,"swing")});var e=$("#topNav").find("nav li");$("#navBtn").on("click tap",function(){if($("body").hasClass("showMobileNav")){var t=e.length,i=100*t;$(this).removeClass("active"),e.each(function(){var e=100*(t-$(this).index()-1),i=$(this);setTimeout(function(){i.removeAttr("style")},e)}),setTimeout(function(){$("body").removeClass("showMobileNav")},i)}else $("body").addClass("showMobileNav"),$(this).addClass("active"),e.each(function(){var e=100*$(this).index(),t=$(this);setTimeout(function(){t.css({top:"0",opacity:"1",visibility:"visible"})},e)})}),$(".navOverlay").on("click tap",function(){$("body").removeClass("showMobileNav"),$("#navBtn").removeClass("active"),$("header nav").hide(300)})});
