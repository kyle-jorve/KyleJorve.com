...
$(document).ready(function(){$('a[href^="#"]').on("click",function(t){var e=$(this).attr("href"),i=$(e).offset().top-$("header").outerHeight();t.preventDefault(),$("html, body").animate({scrollTop:i},1e3,"swing")});var t=$("#topNav").find("nav li");$("#navBtn").on("click tap",function(){if($("body").hasClass("showMobileNav")){var e=t.length,i=100*e;$(this).removeClass("active"),t.each(function(){var t=100*(e-$(this).index()-1),i=$(this);setTimeout(function(){i.removeAttr("style")},t)}),setTimeout(function(){$("body").removeClass("showMobileNav")},i)}else $("body").addClass("showMobileNav"),$(this).addClass("active"),t.each(function(){var t=100*$(this).index(),e=$(this);setTimeout(function(){e.css({top:"0",opacity:"1",visibility:"visible"})},t)})})});
