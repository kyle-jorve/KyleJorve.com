...
$(document).ready(function(){$('a[href^="#"]').on("click",function(t){var e=$(this).attr("href"),o=$(e).offset().top-$("header").outerHeight();t.preventDefault(),$("html, body").animate({scrollTop:o},1e3,"swing")});var t,e;$("#topNav").length>0&&(t=$("#topNav").find("nav li"),e=1e3*parseFloat(window.getComputedStyle(document.querySelector("#topNav")).transitionDuration)/2,$("#navBtn").on("click tap",function(){if($("body").hasClass("showMobileNav")){var o=t.length,a=100*o;$(this).removeClass("active"),t.each(function(){var t=100*(o-$(this).index()-1),e=$(this);setTimeout(function(){e.removeClass("active")},t)}),setTimeout(function(){$("body").removeClass("showMobileNav")},a)}else $("body").addClass("showMobileNav"),$(this).addClass("active"),setTimeout(function(){t.each(function(){var t=100*$(this).index(),e=$(this);setTimeout(function(){e.addClass("active")},t)})},e)}))});
