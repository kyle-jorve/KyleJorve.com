...
$(document).ready(function(){$('a[href^="#"]').on("click",function(t){var e=$(this).attr("href"),i=$(e).offset().top-$("header").outerHeight();t.preventDefault(),$("html, body").animate({scrollTop:i},1e3,"swing")});var t,e,i,a,o,n,s,c,r="#topNav";$(r).length>0&&(t=$(r).find("nav li"),e=1e3*parseFloat(window.getComputedStyle(document.querySelector(r)).transitionDuration)/2,i=$(r).find(".recentWorkContainer"),a=$(r).find(".portfolioItem"),o=$(r).find(".iconContainer li"),n=t.length,s=o.length,c=100*n,$("#navBtn").on("click tap",function(){$("body").hasClass("showMobileNav")?($(this).removeClass("active"),t.each(function(t){var e=100*(n-t-1),i=$(this);setTimeout(function(){i.removeClass("active")},e)}),i.removeClass("active"),a.each(function(t){var e=100*(s-t-1),i=$(this);setTimeout(function(){i.removeClass("active")},e)}),o.each(function(t){var e=100*(s-t-1),i=$(this);setTimeout(function(){i.removeClass("active")},e)}),setTimeout(function(){$("body").removeClass("showMobileNav")},c)):($("body").addClass("showMobileNav"),$(this).addClass("active"),setTimeout(function(){t.each(function(t){var e=100*t,i=$(this);setTimeout(function(){i.addClass("active")},e)}),i.addClass("active"),a.each(function(t){var e=100*t,i=$(this);setTimeout(function(){i.addClass("active")},e)}),o.each(function(t){var e=100*t,i=$(this);setTimeout(function(){i.addClass("active")},e)})},e))}))});
