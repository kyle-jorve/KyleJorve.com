...
var leftNavController=function(){var t=$("#leftNav a"),o=[],e=$(window).scrollTop()+$(window).outerHeight()/2,i={};t.each(function(){o.push($(this).attr("href"))});var n=function(){for(var t=0;t<o.length;t++)i[t]={top:$(o[t]).offset().top,bottom:$(o[t]).offset().top+$(o[t]).outerHeight()}},a=function(){for(var n=0;n<o.length;n++){var a=i[n].top,s=i[n].bottom;$(window).outerWidth()>800&&e>a&&e<s?t[n].classList.add("active"):$(window).outerWidth()>800&&e>a&&e>=s?t[n].classList.remove("active"):$(window).outerWidth()>800&&e<=a&&e<s&&t[n].classList.remove("active")}};return{init:function(){$(document).ready(function(){n(),$(window).scroll(a)}),$(window).on("resize orientationchange",function(){n(),e=$(window).scrollTop()+$(window).outerHeight()/2,a()})}}}();leftNavController.init(),$(document).ready(function(){$('a[href^="#"]').on("click",function(t){var o=$(this).attr("href"),e=$(o).offset().top-$("header").outerHeight();$("html, body").animate({scrollTop:e},1e3,"swing"),t.preventDefault()});var t=$("#topNav").find("nav li");$("#navBtn").on("click tap",function(){if($("body").hasClass("showMobileNav")){var o=t.length,e=100*o;$(this).removeClass("active"),t.each(function(){var t=100*(o-$(this).index()-1),e=$(this);setTimeout(function(){e.removeAttr("style")},t)}),setTimeout(function(){$("body").removeClass("showMobileNav")},e)}else $("body").addClass("showMobileNav"),$(this).addClass("active"),t.each(function(){var t=100*$(this).index(),o=$(this);setTimeout(function(){o.css({top:"0",opacity:"1",visibility:"visible"})},t)})}),$(".navOverlay").on("click tap",function(){$("body").removeClass("showMobileNav"),$("#navBtn").removeClass("active"),$("header nav").hide(300)})});
