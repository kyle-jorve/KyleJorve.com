...
var bodyScrollLim=100;function bodyScroll(o){o<=$(window).scrollTop()?$("body").addClass("scrolled"):$("body").removeClass("scrolled")}function detectTouchDevice(){return"ontouchstart"in document.documentElement}function detectMobile(){return void 0!==window.orientation||-1!==navigator.userAgent.indexOf("IEMobile")}$(document).ready(function(){detectTouchDevice()&&$("body").addClass("touchDevice"),detectMobile()&&$("body").addClass("mobile"),$(".button, button, a").on("tap",function(){var o=$(this);setTimeout(function(){o.removeClass("hover")},300)}),$(window).scroll(function(){bodyScroll(bodyScrollLim)})}),$(window).on("load",function(){bodyScroll(bodyScrollLim),$("body").removeClass("preload")}),window.addEventListener("load",function(){document.querySelector("#loadScreen").classList.remove("active")});
