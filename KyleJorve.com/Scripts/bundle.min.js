...
$(document).ready(function(){$('a[href^="#"]').on("click",function(t){var e=$(this).attr("href"),a=$(e).offset().top-$("header").outerHeight();t.preventDefault(),$("html, body").animate({scrollTop:a},1e3,"swing")});var t,e,a,i,o,n,s,c;$("#topNav").length>0&&(t=$("#topNav").find("nav li"),e=1e3*parseFloat(window.getComputedStyle(document.querySelector("#topNav")).transitionDuration)/2,a=$("#topNav").find(".recentWorkContainer"),i=$("#topNav").find(".portfolioItem"),o=$("#topNav").find(".iconContainer li"),n=t.length,s=o.length,c=100*n,$("#navBtn").on("click tap",function(){$("html").hasClass("showMobileNav")?($(this).removeClass("active"),t.each(function(t){var e=100*(n-t-1),a=$(this);setTimeout(function(){a.removeClass("active")},e)}),a.removeClass("active"),i.each(function(t){var e=100*(s-t-1),a=$(this);setTimeout(function(){a.removeClass("active")},e)}),o.each(function(t){var e=100*(s-t-1),a=$(this);setTimeout(function(){a.removeClass("active")},e)}),setTimeout(function(){$("html").removeClass("showMobileNav")},c)):($("html").addClass("showMobileNav"),$(this).addClass("active"),setTimeout(function(){t.each(function(t){var e=100*t,a=$(this);setTimeout(function(){a.addClass("active")},e)}),a.addClass("active"),i.each(function(t){var e=100*t,a=$(this);setTimeout(function(){a.addClass("active")},e)}),o.each(function(t){var e=100*t,a=$(this);setTimeout(function(){a.addClass("active")},e)})},e))}))});
